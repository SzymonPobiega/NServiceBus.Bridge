namespace NServiceBus.Bridge
{
        ...
        where T : TransportDefinition, new()
    {
        ...
        /// <summary>
        /// Creates a new instance of resubscriber.
        /// </summary>
        /// <param name="inputQueueName">Name of the input queue from which the (un)subscribe messages will be intercepted and replayed.</param>
        /// <param name="delay">Replay delay.</param>
        /// <param name="configureTransport">Callback for configuring the transport.</param>
        ...
        /// <summary>
        /// Callback that needs to be attached to the bridge/switch to intercept forwarded subscribe messages.
        /// </summary>
        public async Task InterceptMessageForwarding(string inputQueue, MessageContext message, Dispatch dispatchMethod, Func<Dispatch, Task> forwardMethod)
        {
            await forwardMethod(dispatchMethod).ConfigureAwait(false);
